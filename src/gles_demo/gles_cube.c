...
static int initializeGLProgram(gles_cube *demo) {
...
static int initializeGL(gles_cube *demo, int width, int height) 
{
...
{
    gles_cube *demo = (gles_cube *)malloc(sizeof(gles_cube));
    if (!demo) {
        return GLFW_FALS;
    }
